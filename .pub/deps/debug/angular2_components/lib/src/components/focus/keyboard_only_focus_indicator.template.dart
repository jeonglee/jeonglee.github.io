...
_ngRef.reflector
..registerType(KeyboardOnlyFocusIndicatorDirective, new _ngRef.ReflectionInfo(
const <dynamic>[],
const [const <dynamic>[ElementRef], const <dynamic>[DomService]],
(ElementRef _element, DomService _domService) => new KeyboardOnlyFocusIndicatorDirective(_element, _domService))
)
;
i0.initReflector();
i1.initReflector();
